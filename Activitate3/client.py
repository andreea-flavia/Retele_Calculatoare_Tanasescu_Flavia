...
class FTPClient:
    ...
    def rename_file(self):
        ...
        old_name = input("Introdu numele vechi al fisierului: ").strip()
        new_name = input("Introdu numele nou al fisierului: ").strip()
        
        if not old_name or not new_name:
            print("✗ Numele fisierelor nu pot fi goale")
            return
    ...
    def read_file(self):
        ...
        filename = input("Introdu numele fisierului pentru citire: ").strip()
    ...
    def download(self):
        ...
        filename = input("Introdu numele fisierului pentru download: ").strip()
        ...
        if response['status'] == 'success':
            ...
            try:
                with open(filepath, 'w') as f:
                    f.write(content)
                print(f"✓ Fisierul a fost salvat local in {filepath}")
            except Exception as e:
    ...
    def edit_file(self):
        ...
        filename = input("Introdu numele fisierului pe care vrei sa il editezi: ").strip()
        if not filename:
            print("✗ Numele fisierului nu poate fi gol")
            return
            
        new_content = input("Introdu noul continut al fisierului: ").strip()
    ...
    def see_file_operation_history(self):
        ...
        filename = input("Introdu numele fisierului pentru a vedea istoricul: ").strip()
        ...
        if response['status'] == 'success':
            ...
            if history:
                ...
                # Daca serverul returneaza doar un mesaj text in loc de lista
                print(f"✓ {response.get('message', 'Nu exista istoric disponibil.')}")
        else:
            print(f"✗ {response['message']}")
