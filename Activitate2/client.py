...
while True:
    ...
    if comanda == 'EXIT':
        ...
        if len(parti) < 2 or not parti[1].strip():
            print("EROARE: Trebuie sa furnizati un mesaj dupa PUBLISH.")
            continue
        raspuns = trimite_comanda(intrare)
        print(raspuns)
        ...
        if len(parti) < 2 or not parti[1].strip().isdigit():
            print("EROARE: Trebuie sa furnizati un ID numeric valid pentru DELETE.")
            continue
        raspuns = trimite_comanda(intrare)
        print(raspuns)
        ...
        if not este_conectat:
            print("EROARE: Trebuie sa fii conectat pentru a vedea lista de mesaje.")
            continue
        raspuns = trimite_comanda(intrare)
        print(raspuns)
